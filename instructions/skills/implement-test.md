...
2. Follow the placement rules in `docs/conventions/page-objects.md` and `docs/conventions/components.md`: selectors come from page objects or components, never inline in the spec.3. Use the locator convention specified in the confirmed scope. If no convention was named, default to `data-qa` attributes.
...
## Output ContractEmit the implementation report as a visible artifact:
