...
## PurposeTurn an underspecified test request into a confirmed, implementable scope before any code is written or changed.

## When to runRun in the main conversation, before reading or editing any test code, whenever the user asks to create or modify a test.
